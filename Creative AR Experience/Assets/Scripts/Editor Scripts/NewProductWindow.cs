...
public class NewProductWindow : EditorWindow
{
    ...
    static void GenerateQR(string encodeText){
        ...
        var dirPath = Application.dataPath + "/Resources/Products/QR Codes/";
        ...
        dirPath = "Assets/Resources/Products/Product Data/";
        if(!Directory.Exists(dirPath)) {
            Directory.CreateDirectory(dirPath);
        }
        var path = "Assets/Resources/Products/Product Data/"+noSpace+".asset";
