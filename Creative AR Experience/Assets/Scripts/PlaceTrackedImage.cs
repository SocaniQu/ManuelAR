...
public class PlaceTrackedImage : MonoBehaviour{
    ...
    /// <summary>
    /// NOTE: DEPRICATED SCRIPT, KEPT FOR POSTERITY
    /// 
    /// this script is a remnant of when placing the AR product display was reliant on detecting tracked images
    /// the product display now is kept at 0,0,0 worldspace, and when a proper QR code is scanned using the QRScanner,
    /// the AR session activates
    /// 
    /// the meaning of code contained here is esoteric, and comments are sparse
